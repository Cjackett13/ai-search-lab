...
function shuffleState() {
  ...
  return shuffled;
  window.findBlankSlot = findBlankSlot;
  window.identifyLegalMoves = identifyLegalMoves;
  window.swapTiles = swapTiles;
  window.checkIfGoalReached = checkIfGoalReached;
  window.boardToString = boardToString;
  window.traceSolution = traceSolution;
  window.shuffleState = shuffleState;
}
